class FacilitySerializer < ActiveModel::Serializer
  ...
  def services
  	object.services_text1 + object.services_text2 + object.services_text3 + object.services_text4 + object.services_text5 + object.services_text6 + object.services_text7
  end
end
