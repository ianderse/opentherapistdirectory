...
function render(element) {
  ...
  var listingElement = $("<li><img src=" + element['picture_url'] + " alt='therapist-picture' class=therapist-thumb><h3>" + element['full_name'] + " " + element['certifications'] + "<p class='phone'>" + element['phone'] + "</p></h3><p>" + location_address + "<p class='description'>\"" + element['trunc_desc'] + "\"</p><br/><div class='bottom-items'><a class='more-information' href='/therapists/" + element['id'] + "'>More Information</a> | " + "<a class='add-therapist' href='/therapist/save/" + element['id'] + "' remote: true> Save Therapist</a></div></li>");
