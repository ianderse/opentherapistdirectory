function render(element) {
  ...
  $('.list').append("<li><h3>" + element.name1 + "</h3><a href='#'><i class='fa fa-plus-circle add-map-pin' style='float:right' data-street='" + location_address + "'></i></a><p>" + location_address + "<br/><a href='/facilities/" + element.id + "'>More Information</a>" + "<a id='add-facility' href='/facility/save/" + element.id + "' remote: true> Save Facility</a>" + "</li>");
};
